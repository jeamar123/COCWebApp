        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="li ins">
                        <a href="#" > <b><center>Timer:</center></b> </a>
                    </li>    
                    <li class="li ins">
                        <a href="#" > <b><center><span id="time">0 hours 0 minutes 0 seconds</span></center></b> </a>
                    </li> 
                    <!-- <li class="ins">
                    ...
                    <li class="li ins">
                        <a href="#" class="hvr-icon-wobble-horizontal"><i class="fa fa-fw fa-file-text"></i> &nbsp; Results</a>
                    </li> -->
                    <li class="ins">
                        <a href="<?php echo site_url("default_con/index/exams")?>" class="hvr-icon-back"><span style="margin-left:20px;">Back to Exams</span></a>
                    </li>
