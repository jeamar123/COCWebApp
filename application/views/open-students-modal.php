<div id="open-students-modal" class="modal fade open-students-modal" role="dialog" aria-labelledby="gridSystemModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <label>Student Name : </label> <label class="modal-title" id="gridSystemModalLabel"></label>
      </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <table id="cla-tbl" class="table table-hover table-striped wow fadeIn">
                ...
                <tbody>
                  <tr ng-repeat="data in classes_by_std | filter:searchText | filter:FilterSec">
