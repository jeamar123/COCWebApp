<div id="check-quiz-modal" class="modal fade check-quiz-modal" role="dialog" aria-labelledby="gridSystemModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <label class="modal-title" id="gridSystemModalLabel">Answers Uploaded</label>
      </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <table class="table table-hover table-striped wow fadeIn">
                ...
                <tbody>
                    <tr ng-repeat="data in quiz_ans | filter:searchText | filter:FilterSec">
                       <!-- <td style="width:1%;"><input id="sec-id" type="checkbox" ng-model="data.Selected" ng-click="checkedbox('{{data.id}}')" name="check-id" value="{{data.id}}"></td> -->
                        ...
                        <td style="width:1%;"><button class="btn btn-primary btn-sm row-open-btn hvr-wobble-horizontal"><i class="fa fa-search"></i></button></td>                                  
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
