<div id="add-assignment-modal" class="modal fade add-assignment-modal" role="dialog" aria-labelledby="gridSystemModalLabel" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <label id="gridSystemModalLabel">Add Assignment</label>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
              ...
              <div class="col-lg-12">
                <form class="form-inline" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <button id="" class="btn btn-danger done-add-ass-btn">Done</button>
                  </div>
                </form>
                <br>
              </div>
          ...
          <div class="summ" hidden>
            ...
            <div class="row">
              <div class="col-lg-2">
                <button id="" class="btn btn-danger hvr-icon-wobble-horizontal done-add-ass-btn" data-loading-text="Loading" autocomplete="off" type="button">Done</button>
              </div>
            </div>
          </div>
        </div>
